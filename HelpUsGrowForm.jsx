...
const STRINGS = {
  en: {
    ...
    consentSub: "Are you OK with receiving email updates from Rosario Palacios (Palacios Contigo, LLC) about this website, related projects, and ways to get involved?",
  ...
  es: {
    ...
    consentSub: "¿Aceptas recibir correos de Rosario Palacios (Palacios Contigo, LLC) sobre este sitio, proyectos relacionados y formas de involucrarte?",
